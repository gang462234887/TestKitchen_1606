...
class CBSubjectCell: UITableViewCell {
    ...
    class func createSubjectCellFor(tableView:UITableView,atIndexPath indexPath:NSIndexPath,withlistModel listModel:CBRecommendWidgeListModel)->CBSubjectCell{
